			...
			<div className="relative  h-[60%]  w-full  bg-[#101010]   pt-10 px-8 py-2 transition-all duration-500 ">
				<div className="w-full h-[530px] huu ">
					<motion.div
						...
						initial="hidden"
						animate="show"
						className="filials_parent max-w-[480px] h-full bgFil  gap-4 rounded-2xl  mx-auto overflow-hidden z-10 relative p-4"
					>
						...
						<p className="text-lg text-black mb-2 ">
							11 - выше ваших ожиданий
						</p>
						<div className="filials_parent" >
							{filialsArr.map((item: any, index: number) => (
								<motion.div
									...
									className={`w-full sm:w-[420px] flex justify-between items-center  mx-auto h-36  mb-4 rounded-xl bgFilialOne relative  px-4 py-2 ${index === 0 ? 'firstChild' : 'secondChild'}`}
									key={index}
								>
