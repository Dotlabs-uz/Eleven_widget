  ...
  async function getFreeTime() {
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        if (moment(today).format("L") === moment(selectDay).format("L")) {
      ...
      <div className="flex flex-col h-full max-w-[600px]  mx-auto  justify-center items-center  bg-[#101010]">
          ...
          <div className="grid grid-cols-3">
            ...
            >
              <ChevronLeft
                ...
                aria-hidden="true"
                className={cn(
                  (isThisMonth(new Date(currentMonth)) && "text-black") ||
                    "text-[#D7A92D]"
                )}
              />
            </button>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      {
                        "text-orange-400  bg-[[#101010]]  ": day === "Sun",
                      }
                    )}
                  >
                    {day}
                  ...
                  >
                    <button
                      ...
                      className={cn(
                        ...
                        isEqual(today, day) && "text-blue-500",
                        isBefore(day, today) &&
                          "text-white bg-[#101010] cursor-not-allowed",
                        isEqual(today, day) && "text-white bg-[#101010]",
        ...
        <div className="w-full h-full  ">
          <div className="w-[90%] mx-auto mt-5 px-6 py-6 h-full flex flex-col justify-start gap-3 border border-[#D7A92D] rounded-xl mb-5 ">
            {active ? (
              <div className="flex flex-col pb-6">
                ...
                >
                  {afternoon.map((item: any, index: number) => (
                    <div
                      key={index}
                      className={`${
                        selectedTime == item
                ...
                {notWorking ? (
                  ...
                  >
                    У этого парикмахера сегодня нет свободного времени😢,
                    пожалуйста, проверьте другие дни.
                  </p>
                ) : (
                  ""
                )}
          ...
          <div className="w-[90%] mx-auto h-full relative">
            ...
            >
              <button
                disabled={selectedTime && selectedDay ? false : true}
